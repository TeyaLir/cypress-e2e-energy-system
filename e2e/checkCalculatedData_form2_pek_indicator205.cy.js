...
import { add } from "../../../../../support/toolbar"
import { pickMonth } from '../../../../../support/pickDate.js'
...
describe('Проверка расчётов формы 2-ПЭК - показатель 205 по разделу 33.1.0', () => {
  ...
  it('33.1.0 п.205 - Проверка вычисленных значений', () => {
    ...
    const value = (((+item_33_1_1_205 * +item_33_1_1_63) + (+item_33_1_2_205 * +item_33_1_2_63) + (+item_33_1_3_205 * +item_33_1_3_63)) / +item_33_1_0_63).toFixed(2);
